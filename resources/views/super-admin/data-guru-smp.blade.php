<!-- resources/views/super-admin/data-guru-smp.blade.php -->
...
<div class="container">
                ...
                @foreach ($guruSMP as $guru)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('super.admin.guru.smp.delete', $guru->id) }}" method="POST" style="display:inline;" class="delete-form">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="editGuruModal{{ $guru->id }}" tabindex="-1" role="dialog" aria-labelledby="editGuruModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="{{ route('super.admin.guru.smp.update', $guru->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editGuruModalLabel">Edit Guru SMP</h5>
    ...
    <div class="modal fade" id="createGuruModal" tabindex="-1" role="dialog" aria-labelledby="createGuruModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('super.admin.guru.smp.store') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="createGuruModalLabel">Tambah Guru SMP</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
