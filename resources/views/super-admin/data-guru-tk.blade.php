<!-- resources/views/super-admin/data-guru-tk.blade.php -->
...
<div class="container">
                ...
                @foreach ($guruTK as $guru)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('super.admin.guru.tk.delete', $guru->id) }}" method="POST" style="display:inline;" class="delete-form">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="editGuruModal{{ $guru->id }}" tabindex="-1" role="dialog" aria-labelledby="editGuruModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="{{ route('super.admin.guru.tk.update', $guru->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
    ...
    <div class="modal fade" id="createGuruModal" tabindex="-1" role="dialog" aria-labelledby="createGuruModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('super.admin.guru.tk.store') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="createGuruModalLabel">Tambah Guru TK</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
